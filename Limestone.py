...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 17 07:23:54 2024

@author: keiragupta
"""
"""
COMPARISON 2: LIMESTONE
...
limestone, which has a high wave velocity. It is meant to be used as a comparison with "Seismic Waves (Taylor's Version)",
...
the ground, given a constant (fast) velocity. The final figure shows that the songs do not take much time to travel due to 
the high velocity.
...
* A P-wave velocity for Limestone was drawn from this source.
...
velocity[x >= 5000] = 6000 # m/s - loading in the velocity at node 1 instead of node 0
...
plt.ylabel('Time (min)')
plt.title('The Eras Tour Seismic Intensity Profile: Through Time and over Limestone')
plt.legend()
plt.show() 